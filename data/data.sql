...
VALUES
  ...
  (5, 'Create PHPantastic packages', 'session', 'You''ve created a solution in a niche problem space, and now want to open source it; how do you go about doing so? What license will you choose? How will you prevent backwards compatibility breaks? How will you ensure consistency amongst diverse contributors? In this session we''ll go over the various aspects of good package design and tools you can use to ensure great quality and collaboration.', '2016-10-19', '10:15', '11:15', 'The Joint'),
  (6, 'Use Zend components anywhere', 'session', 'Composer allows you to manage per-project dependencies, and to select components that best solve your application problems, regardless of what framework you use. This past year, Zend Framework has decoupled its components to fit this paradigm, letting you use Zend components anywhere. In this session we''ll cherry pick several of them, demonstrating usage in diverse, real-world applications.', '2016-10-20', '11:30', '12:30', 'Festival 1');
